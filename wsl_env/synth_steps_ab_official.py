# -*- coding: utf-8 -*-
"""用官方预训练权重生成"步数/sway"对比音频（供人耳试听）。
输出：/mnt/d/PycharmProjects/PythonProject9/Matcha-TTS/test_audio/sway_steps_official/<cfg>/sentence_i.wav
"""
import sys
...
CKPT = "/mnt/d/PycharmProjects/PythonProject9/Matcha-TTS/logs/train/ljspeech_min/runs/matcha_ljspeech.ckpt"
VAL = Path("/home/zkw/projects/Matcha-TTS/data/LJSpeech-1.1/val.txt")
OUT = Path("/mnt/d/PycharmProjects/PythonProject9/Matcha-TTS/test_audio/sway_steps_official")
...
with torch.inference_mode():
    for name, steps, sway in CFGS:
        ...
        print(f"[+] official {name}: steps={steps} sway={sway}")
print("DONE")
